...
<div id="content">
	...
	<table id="tabel-tampil">
		...
		if($_SERVER['REQUEST_METHOD'] == "POST"){
			...
			if($pencarian != ""){
				$sql = "SELECT * FROM buku WHERE judul_buku LIKE '%$pencarian%'
		...
		<tr>
			...
			<td>
				<div class="tombol-opsi-container"><a href="index.php?p=buku-edit&id=<?php echo $r_tampil_buku['id_buku'];?>" class="tombol">Edit</a></div>
				<div class="tombol-opsi-container"><a href="proses/buku-hapus.php?id=<?php echo $r_tampil_buku['id_buku']; ?>" onclick = "return confirm ('Apakah Anda Yakin Akan Menghapus Data Ini?')" class="tombol">Hapus</a></div>
			</td>			
		</tr>		
		<?php $nomor++; } 
		}
