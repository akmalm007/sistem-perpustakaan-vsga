...
<div id="content">
	...
	<table id="tabel-input">
		...
		<tr>
			...
			<td class="isian-formulir"><input type="text" name="nama" value="<?php echo $r_tampil_anggota['nama_anggota']; ?>" class="isian-formulir isian-formulir-border"></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="isian-formulir"><input type="text" name="nomor_telepon" value="<?php echo $r_tampil_anggota['nomor_tlp']; ?>" class="isian-formulir isian-formulir-border"></td>
		</tr>
		<tr>
			<td class="label-formulir">Email</td>
			<td class="isian-formulir"><input type="text" name="email" value="<?php echo $r_tampil_anggota['email']; ?>" class="isian-formulir isian-formulir-border"></td>
		</tr>
		<tr>
